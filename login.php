    ...
    <nav>
        ...
        <section class="contents">
            <div class="log-container snake-border">
                ...
                <div class="right animr">
                    <h1>User Login</h1>
                    <div class="inp">
                        <form action="valid.php" method="post">
                            <input type="text" name="email" id="" placeholder="Email" required>
                            <input type="password" name="password" id="" placeholder="Password" required>
                            <button type="submit" class="btnn btnn-pri">Log In</button>
                        </form>
                    </div>
                    <div class="forget-contain">
                        <span>Forget</span> 
                        <span> <a href="">Username</a> / <a href="">Password?</a></span>
                    </div>
                    <a href="signup.php" class="create-link">Create your Account <i class="uil uil-arrow-right"></i></a>
                </div>
            </div>
        </section>
